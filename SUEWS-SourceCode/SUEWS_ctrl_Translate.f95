...
!!! N.B. will need to check input files are correctly set up
  ...
  IF (ir==1.AND.iMB==1) THEN   !For first row of first block only
     ...
     ! WRITE(12,'(2f10.3,3f,3f10.3,a16)') FCskip,FCskip,LAIPower(1,1:nvegsurf),FCskip,FCskip,FCskip, ' LAI_LeafGP1'
     WRITE(12,'(2f10.3,3f10.5,3f10.3,a16)') FCskip,FCskip,(LAIPower(1,iv),iv=1,nvegsurf),FCskip,FCskip,FCskip, ' LAI_LeafGP1'
     WRITE(12,'(2f10.3,3f10.5,3f10.3,a16)') FCskip,FCskip,(LAIPower(2,iv),iv=1,nvegsurf),FCskip,FCskip,FCskip, ' LAI_LeafGP2'
     WRITE(12,'(2f10.3,3f10.5,3f10.3,a16)') FCskip,FCskip,(LAIPower(3,iv),iv=1,nvegsurf),FCskip,FCskip,FCskip, ' LAI_LeafOP1'
     WRITE(12,'(2f10.3,3f10.5,3f10.3,a16)') FCskip,FCskip,(LAIPower(4,iv),iv=1,nvegsurf),FCskip,FCskip,FCskip, ' LAI_LeafOP2'
