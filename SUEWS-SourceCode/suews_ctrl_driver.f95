...
CONTAINS
  ...
  SUBROUTINE SUEWS_cal_Main(&
       ...
       MeltWaterStore,MetForcingData_grid,MinFCMetab,MinQFMetab,min_res_bioCO2,&
    ...
    CALL SUEWS_cal_AnthropogenicEmission(&
         ...
         FrFossilFuel_NonHeat,HDD_id,HumActivity_24hr,id,imin,it,dectime,&
         LAI_id,LAIMax,LAIMin,MinFCMetab,MaxFCMetab,MaxQFMetab,MinQFMetab,&
         min_res_bioCO2,nsh,NumCapita,PopDensDaytime,PopDensNighttime,&
         PopProf_24hr,QF,QF0_BEU,Qf_A,Qf_B,Qf_C,QF_SAHP,&
  ...
  SUBROUTINE SUEWS_cal_AnthropogenicEmission(&
    ...
    IF(EmissionsMethod>=11) THEN
       ...
       CALL CO2_biogen(dectime,EmissionsMethod,&
  ...
  ! Last modified: LJ Jan 2019 - weighting of evaporation fixed
  ...
  SUBROUTINE SUEWS_cal_multitsteps(&
       ...
       MeltWaterStore,MinFCMetab,MinQFMetab,min_res_bioCO2,&
       NARP_EMIS_SNOW,NARP_TRANS_SITE,NetRadiationMethod,&
       NumCapita,OHM_coef,OHMIncQF,OHM_threshSW,&
       OHM_threshWD,PipeCapacity,PopDensDaytime,&
       PopDensNighttime,PopProf_24hr,PorMax_dec,PorMin_dec,&
       ...
       SatHydraulicConduct,SDDFull,sfr,SMDMethod,SnowAlb,SnowAlbMax,&
       SnowAlbMin,snowD,SnowDens,SnowDensMax,SnowDensMin,SnowfallCum,snowFrac,&
       SnowLimBuild,SnowLimPaved,SnowPack,SnowProf_24hr,snowUse,SoilDepth,&
       soilmoist_id,SoilStoreCap,StabilityMethod,startDLS,state_id,StateLimit,&
       StorageHeatMethod,StoreDrainPrm,SurfaceArea,Tair24HR,tau_a,tau_f,tau_r,&
    ...
    DO ir = 1, len_sim, 1
       ...
       CALL SUEWS_cal_Main(&
            ...
            iy,kkAnOHM,Kmax,LAI_id,LAICalcYes,LAIMax,LAIMin,LAI_obs,&
            LAIPower,LAIType,lat,ldown_obs,lng,MaxConductance,MaxFCMetab,MaxQFMetab,&
            MeltWaterStore,MetForcingBlock,MinFCMetab,MinQFMetab,min_res_bioCO2,&
            NARP_EMIS_SNOW,NARP_TRANS_SITE,NetRadiationMethod,&
            NumCapita,OHM_coef,OHMIncQF,OHM_threshSW,&
            OHM_threshWD,PipeCapacity,PopDensDaytime,&
            PopDensNighttime,PopProf_24hr,PorMax_dec,PorMin_dec,&
