...
!   calculate heat storage related parameters:
    ...
    eta  = atan(xx1/xx2)
    if ( eta<0 ) write(*,*) 'lambda,delta,m,n,gamma:', lambda,delta,m,n,gamma  
...
!   key phase lag:
    xlag = eta-phi
  write(*,*) 'tau,eta,phi,xlag:',tau/pi*180,eta/pi*180,phi/pi*180,xlag/pi*180

!   calculate the OHM coeffs.:
!   a1:  
    xa1  = (ceta*cos(xlag))/cphi
    
  write(*,*) 'ceta,cphi,ceta/cphi/2pi:', ceta,cphi,ceta/cphi/2/pi*24
!   a2:
