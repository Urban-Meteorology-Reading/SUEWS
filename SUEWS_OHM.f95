...
CONTAINS
  ...
  SUBROUTINE OHM(Gridiv)
    ...
    CALL OHM_coef_cal(sfr,nsurf,a1,a2,a3)
    ...
    IF(qn1>-999) THEN   !qn1 = Net all-wave radiation [W m-2]
       ...
       CALL OHM_dqndt_cal(nsh,qn1,qn1_store(:,Gridiv),qn1_av_store(:,Gridiv),dqndt)
    ...
    IF(snowUse==1) THEN
       ...
       IF(qn1_S>-999) THEN
          ...
          ! Store instantaneous qn1 values for previous hour (qn1_store) and average (qn1_av)
          CALL OHM_dqndt_cal(nsh,qn1_S,qn1_S_store(:,Gridiv),qn1_S_av_store(:,Gridiv),dqndt)
  ...
  SUBROUTINE OHM_coef_cal(sfr,nsurf,a1,a2,a3)
    IMPLICIT NONE
  ...
  SUBROUTINE OHM_dqndt_cal(nsh,qn1,qn1_store,qn1_av_store,dqndt)
    ...
    REAL(KIND(1d0)), INTENT(inout) ::qn1
