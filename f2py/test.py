...
albdectr = 0.3 * np.ones(367)
albedochoice = 1  # : input int
# : in/output rank-1 array('d') with bounds (367)
albevetr = 0.3 * np.ones(367)
# : in/output rank-1 array('d') with bounds (367)
albgrass = 0.3 * np.ones(367)
albmax_dectr = 0.3  # : input float
albmax_evetr = 0.3  # : input float
albmax_grass = 0.3  # : input float
albmin_dectr = 0.3  # : input float
albmin_evetr = 0.3  # : input float
albmin_grass = 0.3  # : input float
alpha_bioco2 = 0.3 * np.ones(3)  # : input rank-1 array('d') with bounds (3)
