...
if translate == 1:
    ...
    old = 0 # This should be 0. Only used for old SOLWEIG-files
    ...
    delim = ' ' # delimiter of output file
    if timeinterpol == 0: ## This part converts metdata into 5 min
        ...
        numformat = numformat = '%3d %2d %3d %2d %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f'
        ...
        header = '%iy  id   it imin dectime    kdown     kup    ldown     lup     Tsurf     qn      h_mod    e_mod     ' \
                 ...
                 'Tsnow_ET Tsnow_DTTsnow_IG Tsnow_UG Tsnow_wtr'
